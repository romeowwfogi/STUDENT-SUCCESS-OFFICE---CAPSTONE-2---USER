...
try {
    ...
    $MESSAGE = getConfigValue(
        ...
        "We couldn’t send the verification link due to a system issue or invalid email address. Please double-check your information and try again later. If the issue persists, contact support."
    );
    http_response_code(500);
    echo json_encode([
        "status" => "error",
