...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2025 at 05:44 AM
...
(1, '2025-11-10 06:32:00', '2025-11-17 06:32:00', '2025', '2026', 0, 1),
(2, '2025-11-10 12:58:00', '2025-11-17 12:58:00', '2025', '2026', 0, 0);
...
(114, 21, 'test', 'Test', 'file', '', 0, 1, 1, '', '.pdf,.jpg,.png', 10, NULL, NULL);
...
(21, 4, 'Step 1: Testing File Path', '', 0, 1);
...
(13, 5, 4, '2025-11-11 05:40:12', 'Pending', 'Thank you for your submission. Your application is still being processed, and additional time is required to complete the review.', 0);
...
(3, 13, 'test', 'System Evaluation Tool.docx.pdf', 'http://localhost/pages/src/media/private/4e1d936b0256f54e_System_Evaluation_Tool.docx.pdf');
...
(8, 5, 'SESSION', '4e72e13cd9f87f8e7fe0396071cbd739412f19e9121f16fcf86f7d2877be28d7', 0, '2025-11-18 02:54:53', '2025-11-11 02:54:53');
...
CREATE TABLE admission_controller ( id INT(11) NOT NULL, user_id INT(11) NOT NULL, can_apply TINYINT(1) NOT NULL DEFAULT 1 ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

ALTER TABLE admission_controller ADD CONSTRAINT admission_controller_fk_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;
